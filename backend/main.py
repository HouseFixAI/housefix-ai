...
INSPIRATION_PROMPT = (
    ...
    "licht zorgen voor de sfeer. Leg ook uit waarom de geadviseerde producten, "
    "kleuren en stijl juist bij deze specifieke ruimte passen — niet alleen in "
    "het algemeen. Waaróm past deze bank, waarom deze kleur bij dit licht, "
    "waarom dit materiaal bij deze sfeer? Sluit af met een concrete suggestie "
    "waarmee de gebruiker deze uitstraling zelf kan creëren of aanvullen. "
