...
COLOR_PALETTE_PROMPT = (
    ...
    "Return valid JSON with these keys:\n"
    "intent (altijd 'identify'),\n"
    "colors (lijst van 4-8 objecten met: name (Nederlandse kleurnaam), hex (6-digit CSS hex code, bv #FFFDD0). Elke kleur MOET een hex-veld hebben.\n"
    "Voorbeeld: [{\"name\": \"crème\", \"hex\": \"#FFFDD0\"}]),\n"
    ""
    ...
    "paint_tips (lijst van 2-4 objecten met: store (winkel/merk), product (productnaam), hex (6-digit CSS hex code), name (kleurnaam), "
