...
COST_EXPERT_PROMPT = (
    ...
    "Vermijd vage taal. Zeg niet 'het kan vari\u00ebren', maar "
...
COLOR_PALETTE_PROMPT = (
    ...
    "Return valid JSON with these keys:\n"
    "intent (altijd 'identify'),\n"
    "harmony (ALTIJD 2-3 zinnen, PERSOONLIJK advies gebaseerd op deze foto. Vertel WELKE kleuren uit het palet mooi combineren en WAAROM. Gebruik kleurenleer: complementair, analoog, triadisch. Voorbeeld: 'Het warme mosterdgeel combineert prachtig met het antraciet voor een modern contrast. Samen met het eiken creëert het een gebalanceerd geheel.' Dit is GEEN toepassingsadvies — alleen over kleurcombinaties. Verplicht veld!),\n"
    "application (ALTIJD 2-3 zinnen, PERSOONLIJK advies gebaseerd op deze foto. Vertel WELKE muur/meubel/accessoire in WELKE kleur uit het palet. Voorbeeld: 'Dit warme zand op de accentmuur achter de bank, het saliegroen op kussens en plantenbakken, de koperen accessoires als highlights.' Dit is GEEN kleurenleer — alleen over toepassing in de ruimte. Verplicht veld!),\n"
